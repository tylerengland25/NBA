from scraper import MonthScraper, TotalsScraper
import pandas as pd
...
def scrape_season(season, months, latest_date, current_date):
    ...
    for month in months:
        scraper = MonthScraper(f'https://www.basketball-reference.com/leagues/NBA_{season + 1}_games-{month}.html', latest_date, current_date, TotalsScraper)
